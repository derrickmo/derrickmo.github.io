...
window.PLAY_DEMOS = {
  ...
  categories: [
    ...
    { name: "Graphs & Networks", why: "The algorithms for data shaped like a network — webs, maps, social graphs, dependencies. Ranking nodes by who points at them, finding shortest routes and cheapest spanning structures, carving out communities, and pushing maximum flow through a capacitated network. The classical backbone under graph ML.", slugs: ["pagerank", "dijkstra"] },
  ],
