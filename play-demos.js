...
window.PLAY_DEMOS = {
  ...
  categories: [
    ...
    { name: "Trustworthy & Explainable ML", why: "Whether you can actually trust what a model outputs: are its confidence scores honest, and can you explain why it decided what it did? The layer that turns a black-box predictor into something you'd deploy where the stakes are real.", slugs: ["calibration", "shap", "saliency", "sparse-autoencoder", "probing-classifier", "conformal", "conformal-regression", "mc-dropout", "active-learning", "coreset", "dataset-distillation", "label-noise", "drift-detection", "fairness"] },
