...
clf("HuggingFace makes this delightfully easy")  # -> [{'label': 'POSITIVE', ...}]`,
      ...
      notebooks: [
        { n: "00_01", t: "Tokenization & Embeddings", models: "AutoTokenizer", d: "BPE, WordPiece, vocabulary, special tokens, embeddings.", diff: "Beginner" },
        { n: "00_02", t: "Transformer Architecture", models: "AutoModel", d: "Self-attention, multi-head attention, encoder vs decoder.", diff: "Beginner" },
        { n: "00_03", t: "HuggingFace Ecosystem", models: "Pipeline, HfApi", d: "Hub navigation, AutoClasses, pipelines, model cards.", diff: "Beginner" },
        { n: "00_04", t: "Preprocessors & Feature Extractors", models: "AutoProcessor", d: "Unified preprocessing, padding/truncation, multimodal processors.", diff: "Beginner" },
        { n: "00_05", t: "Model Configuration & Customization", models: "AutoConfig", d: "config.json, model surgery, freezing, memory estimation.", diff: "Beginner" },
      ],
    },
    {
...
gen("In the future, AI will", max_new_tokens=20, do_sample=True)`,
      ...
      notebooks: [
        { n: "01_01", t: "Text Generation", models: "GPT-2, DistilGPT2", d: "Causal LM, greedy/beam/sampling decoding.", diff: "Beginner" },
        { n: "01_02", t: "Text Classification", models: "DistilBERT, BERT", d: "Sentiment analysis and topic classification.", diff: "Beginner" },
        { n: "01_03", t: "Text Summarization", models: "DistilBART, BART", d: "Abstractive summarization, seq2seq.", diff: "Intermediate" },
        { n: "01_04", t: "Named Entity Recognition", models: "DistilBERT-NER", d: "Token classification, BIO tags, span extraction.", diff: "Intermediate" },
        { n: "01_05", t: "Question Answering", models: "DistilBERT-QA", d: "Extractive QA — context + question to answer span.", diff: "Intermediate" },
        { n: "01_06", t: "Translation", models: "MarianMT", d: "Machine translation, multilingual, beam search.", diff: "Intermediate" },
        { n: "01_07", t: "Fine-tuning (Unsloth)", models: "Llama 3.2 / 3.1", d: "2-5x faster LLM fine-tuning (GPU).", diff: "Advanced" },
        { n: "01_08", t: "Fine-tuning (LoRA)", models: "GPT-2", d: "Adapter training with LoRA (CPU-compatible).", diff: "Advanced" },
      ],
    },
    {
...
clf("photo.jpg")[:3]      # top-3 labels with scores`,
      ...
      notebooks: [
        { n: "02_01", t: "Image Classification", models: "ViT", d: "Identify objects in images.", diff: "Beginner" },
        { n: "02_02", t: "Object Detection", models: "DETR, YOLOv8", d: "Detect and localize multiple objects.", diff: "Intermediate" },
        { n: "02_03", t: "OCR", models: "TrOCR, PaddleOCR", d: "Extract text from images (80+ languages).", diff: "Intermediate" },
        { n: "02_04", t: "Image Segmentation", models: "SegFormer", d: "Semantic, instance, and panoptic segmentation.", diff: "Intermediate" },
      ],
    },
    {
...
asr("audio.wav")["text"]`,
      ...
      notebooks: [
        { n: "03_01", t: "Speech Recognition", models: "Whisper", d: "Transcribe audio to text.", diff: "Intermediate" },
        { n: "03_02", t: "Text-to-Speech", models: "SpeechT5", d: "Generate natural-sounding speech.", diff: "Intermediate" },
        { n: "03_03", t: "Audio Classification", models: "AST", d: "Environmental sounds, music genre classification.", diff: "Intermediate" },
      ],
    },
    {
...
cap("photo.jpg")[0]["generated_text"]`,
      ...
      notebooks: [
        { n: "04_01", t: "Image-to-Text (Captioning)", models: "BLIP", d: "Generate captions from images.", diff: "Intermediate" },
        { n: "04_02", t: "Visual Question Answering", models: "ViLT", d: "Ask questions about images.", diff: "Intermediate" },
        { n: "04_03", t: "Text-to-Image Generation", models: "Stable Diffusion", d: "Prompt engineering, negative prompts, schedulers.", diff: "Intermediate" },
        { n: "04_04", t: "Image Editing & Inpainting", models: "SD Inpainting, InstructPix2Pix", d: "Inpainting, img2img, instruction-based editing.", diff: "Advanced" },
        { n: "04_05", t: "Document Understanding", models: "LayoutLM, Donut", d: "Form parsing, receipt extraction, document QA.", diff: "Advanced" },
      ],
    },
    {
...
model = AutoModelForCausalLM.from_pretrained("gpt2", quantization_config=cfg)`,
      ...
      notebooks: [
        { n: "05_01", t: "Ollama Integration", models: "Local LLMs", d: "Use Ollama models with HuggingFace tools.", diff: "Intermediate" },
        { n: "05_02", t: "Performance & Caching", models: "Optimization", d: "Latency, throughput, batching, cost estimation.", diff: "Intermediate" },
        { n: "05_03", t: "Model Cards & AI Ethics", models: "Responsible AI", d: "Bias, fairness, and documentation.", diff: "Intermediate" },
        { n: "05_04", t: "HuggingFace Datasets", models: "datasets", d: "Load, filter, preprocess, and create custom datasets.", diff: "Beginner" },
        { n: "05_05", t: "Gradio & Spaces", models: "gradio", d: "Build web UIs and deploy to HuggingFace Spaces.", diff: "Intermediate" },
        { n: "05_06", t: "Quantization & Compression", models: "ONNX", d: "INT8 quantization, ONNX export, benchmarking.", diff: "Intermediate" },
        { n: "05_07", t: "Quantization Deep Dive", models: "GPTQ, AWQ, bitsandbytes", d: "4-bit/8-bit, perplexity evaluation.", diff: "Advanced" },
        { n: "05_08", t: "Training Best Practices", models: "Trainer API", d: "LR schedules, grad accumulation, mixed precision.", diff: "Advanced" },
      ],
    },
    {
...
person = extract(prompt, response_model=Person)   # typed, validated output`,
      ...
      notebooks: [
        { n: "06_01", t: "MCP Basics", models: "Tool-using agents", d: "Model Context Protocol fundamentals, tool calling.", diff: "Intermediate" },
        { n: "06_02", t: "MCP Servers", models: "Reusable tools", d: "Build file system and data analysis servers.", diff: "Advanced" },
        { n: "06_03", t: "Multi-Tool Agents", models: "Agent patterns", d: "ReAct, Plan-and-Execute, Reflection.", diff: "Advanced" },
        { n: "06_04", t: "RAG with Local LLMs", models: "FAISS, ChromaDB", d: "Vector databases, semantic search, context injection.", diff: "Advanced" },
        { n: "06_05", t: "Structured Output", models: "Pydantic, instructor", d: "JSON mode, validation, function-calling patterns.", diff: "Advanced" },
      ],
    },
  ],
};
