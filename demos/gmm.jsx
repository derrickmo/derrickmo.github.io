  ...
  const explainer = (
    <>
      ...
      <DemoP>
        ...
        rotated</i> clusters because each component carries a full covariance matrix, and the same ellipse geometry comes straight from its 2×2 eigen-decomposition.
  ...
  const concepts = (
    <>
      ...
      <DemoP>
        ...
        directly. That exact pattern, and the "responsibility / latent variable" framing, is the
        conceptual ancestor of variational inference and the ELBO objective that
