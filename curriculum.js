// curriculum.js — single source of truth for all 25 modules + 250 lessons.
...
window.CURRICULUM = {
  modules: [
    ...
    },
    {
      ...
      status: "PENDING",
      lessons: [
        { n: "21-01", slug: "agent-loop", title: "The Agent Loop: Perceive, Reason, Act", status: "PENDING" },
        { n: "21-02", slug: "tool-calling", title: "Tool Calling & Function Calling", status: "PENDING" },
        { n: "21-03", slug: "mcp", title: "MCP: Protocol, Clients & Servers", status: "PENDING" },
        { n: "21-04", slug: "react-planning", title: "ReAct, Planning & Task Decomposition", status: "PENDING" },
        { n: "21-05", slug: "agent-memory", title: "Agent Memory & Context Management", status: "PENDING" },
        { n: "21-06", slug: "multi-agent", title: "Multi-Agent Orchestration", status: "PENDING" },
        { n: "21-07", slug: "agent-evaluation", title: "Agent Evaluation: Tasks & Trajectories", status: "PENDING" },
        { n: "21-08", slug: "observability", title: "Observability, Tracing & Cost Control", status: "PENDING" },
        { n: "21-09", slug: "agent-security", title: "Guardrails & Agent Security", status: "PENDING" },
        { n: "21-10", slug: "agent-capstone", title: "Capstone: Build a Production Agent", status: "PENDING" },
      ],
    },
    {
      n: "22", slug: "frontier-frameworks",
      ...
      status: "PENDING",
      lessons: [
        { n: "22-01", slug: "jax-fundamentals", title: "JAX & Functional ML: jit, grad, vmap", status: "PENDING" },
        { n: "22-02", slug: "flax-optax", title: "Training in JAX with Flax & Optax", status: "PENDING" },
        { n: "22-03", slug: "open-weight-models", title: "The Open-Weight Model Landscape", status: "PENDING" },
        { n: "22-04", slug: "vllm-inference", title: "Inference Engines: vLLM & Paged Attention", status: "PENDING" },
        { n: "22-05", slug: "torch-compile-triton", title: "torch.compile & GPU Kernels with Triton", status: "PENDING" },
        { n: "22-06", slug: "onnx-export", title: "Model Export: ONNX & Quantized Runtimes", status: "PENDING" },
        { n: "22-07", slug: "provider-apis", title: "Provider APIs in Production", status: "PENDING" },
        { n: "22-08", slug: "finetuning-stacks", title: "Modern Fine-Tuning Stacks", status: "PENDING" },
        { n: "22-09", slug: "eval-harnesses", title: "Evaluation Harnesses & Custom Evals", status: "PENDING" },
        { n: "22-10", slug: "staying-current", title: "Staying Current: Releases, Benchmarks & Changelogs", status: "PENDING" },
      ],
    },
    {
      n: "23", slug: "causal-inference",
      ...
      status: "PENDING",
      lessons: [
        { n: "23-01", slug: "potential-outcomes", title: "Potential Outcomes & Treatment Effects", status: "PENDING" },
        { n: "23-02", slug: "causal-graphs", title: "Causal Graphs & do-Calculus", status: "PENDING" },
        { n: "23-03", slug: "confounding", title: "Confounding & Simpson's Paradox", status: "PENDING" },
        { n: "23-04", slug: "instrumental-variables", title: "Instrumental Variables", status: "PENDING" },
        { n: "23-05", slug: "propensity-matching", title: "Propensity Scores & Matching", status: "PENDING" },
        { n: "23-06", slug: "uplift-modeling", title: "Uplift Modeling", status: "PENDING" },
        { n: "23-07", slug: "ab-testing", title: "A/B Testing & Experimentation at Scale", status: "PENDING" },
        { n: "23-08", slug: "resampling", title: "Bootstrap, Permutation & Resampling", status: "PENDING" },
        { n: "23-09", slug: "bayesian-workflow", title: "The Bayesian Workflow", status: "PENDING" },
        { n: "23-10", slug: "time-series-causality", title: "Time-Series Causality & Synthetic Control", status: "PENDING" },
      ],
    },
    {
      n: "24", slug: "trustworthy-ai",
      ...
      status: "PENDING",
      lessons: [
        { n: "24-01", slug: "calibration", title: "Calibration & Temperature Scaling", status: "PENDING" },
        { n: "24-02", slug: "conformal-prediction", title: "Conformal Prediction", status: "PENDING" },
        { n: "24-03", slug: "fairness", title: "Fairness Metrics & Trade-offs", status: "PENDING" },
        { n: "24-04", slug: "attribution", title: "Attribution: SHAP, Saliency & Attention Rollout", status: "PENDING" },
        { n: "24-05", slug: "superposition-sae", title: "Mechanistic Interpretability I: Superposition & SAEs", status: "PENDING" },
        { n: "24-06", slug: "probing-patching", title: "Mechanistic Interpretability II: Probing & Activation Patching", status: "PENDING" },
        { n: "24-07", slug: "adversarial-robustness", title: "Adversarial Robustness & Certified Defenses", status: "PENDING" },
        { n: "24-08", slug: "distribution-shift", title: "Distribution Shift & Drift Detection", status: "PENDING" },
        { n: "24-09", slug: "red-teaming", title: "Red-Teaming & Model Auditing", status: "PENDING" },
        { n: "24-10", slug: "alignment-governance", title: "Alignment & Governance Overview", status: "PENDING" },
      ],
    },
    {
      n: "25", slug: "interview-capstone",
      ...
      status: "PENDING",
      lessons: [
        { n: "25-01", slug: "interview-landscape", title: "The ML Interview Landscape & Strategy", status: "PENDING" },
        { n: "25-02", slug: "system-design-framework", title: "ML System Design Framework", status: "PENDING" },
        { n: "25-03", slug: "design-recommender", title: "Design Case: Recommender & Feed", status: "PENDING" },
        { n: "25-04", slug: "design-search-ads", title: "Design Case: Search & Ads", status: "PENDING" },
        { n: "25-05", slug: "design-fraud-llm", title: "Design Case: Fraud Detection & LLM Products", status: "PENDING" },
        { n: "25-06", slug: "coding-patterns", title: "Coding Patterns for ML Interviews", status: "PENDING" },
        { n: "25-07", slug: "cs-algorithms", title: "Classical CS Algorithms Review", status: "PENDING" },
        { n: "25-08", slug: "breadth-rapid-fire", title: "ML Breadth Rapid-Fire", status: "PENDING" },
        { n: "25-09", slug: "derivations", title: "Deep-Dive Derivations", status: "PENDING" },
        { n: "25-10", slug: "portfolio-capstone", title: "Take-Homes, Storytelling & Portfolio Capstone", status: "PENDING" },
      ],
    },
  ],
