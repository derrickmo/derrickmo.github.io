  ...
  modules: [
    ...
    },
    {
      ...
      lessons: [
        ...
        { n: "02-04", slug: "boosting", title: "Gradient Boosting & AdaBoost", status: "LIVE" },
    ...
    },
    {
      ...
      lessons: [
        ...
        { n: "03-09", slug: "matrix-factorization", title: "Matrix Factorization & Decomposition", status: "LIVE" },
    ...
    },
    {
      ...
      lessons: [
        ...
        { n: "04-06", slug: "learning-theory", title: "Learning Theory — VC Dimension, PAC Learning", status: "LIVE" },
    ...
    },
    {
      ...
      lessons: [
        ...
        { n: "08-05", slug: "full-transformer", title: "Full Transformer — Encoder-Decoder", status: "LIVE" },
    ...
    },
    {
      ...
      status: "LIVE",
      lessons: [
        { n: "10-01", slug: "gpt", title: "GPT-Style Autoregressive Language Modeling", status: "LIVE" },
    ...
    },
    {
      ...
      status: "LIVE",
      lessons: [
        { n: "12-01", slug: "clip", title: "CLIP — Contrastive Image-Text Pretraining", status: "LIVE" },
    ...
    },
    {
      ...
      lessons: [
        ...
        { n: "14-08", slug: "model-based-rl", title: "Model-Based RL & MCTS", status: "LIVE" },
    ...
    },
    {
      ...
      status: "LIVE",
      lessons: [
        { n: "15-01", slug: "custom-autograd", title: "Custom Autograd Functions & Hooks", status: "LIVE" },
    ...
    },
    {
      ...
      lessons: [
        ...
        { n: "17-08", slug: "long-context", title: "Long Context — RoPE Scaling & Sliding Window", status: "LIVE" },
    ...
    },
    {
      ...
      status: "LIVE",
      lessons: [
        { n: "19-01", slug: "recommenders-cf", title: "Recommender Systems — Collaborative Filtering", status: "LIVE" },
    ...
    },
    {
      ...
      lessons: [
        ...
        { n: "20-10", slug: "system-design", title: "ML System Design Patterns", status: "LIVE" },
      ],
    },
  ],
