  ...
  modules: [
    {
      ...
      lessons: [
        ...
        { n: "01-06", slug: "linear-algebra", title: "Linear Algebra for Machine Learning", status: "PENDING" },
    ...
    },
    {
      ...
      lessons: [
        ...
        { n: "05-04", slug: "loss-functions", title: "Loss Functions Deep Dive", status: "PENDING" },
        { n: "05-05", slug: "forward-pass", title: "Forward Pass & Computational Graphs", status: "PENDING" },
    ...
    },
    {
      ...
      lessons: [
        ...
        { n: "07-05", slug: "seq2seq-attention", title: "Sequence-to-Sequence with Attention", status: "PENDING" },
    ...
    },
    {
      ...
      lessons: [
        ...
        { n: "09-02", slug: "object-detection", title: "Object Detection Fundamentals", status: "PENDING" },
    ...
    },
    {
      ...
      lessons: [
        ...
        { n: "13-08", slug: "rlhf-ppo", title: "RLHF with PPO", status: "PENDING" },
    ...
    },
    {
      ...
      lessons: [
        ...
        { n: "16-08", slug: "ddp", title: "Distributed Data Parallel (DDP)", status: "PENDING" },
    ...
    },
    {
      ...
      lessons: [
        ...
        { n: "18-04", slug: "rag-pipeline", title: "RAG Pipeline End-to-End", status: "PENDING" },
