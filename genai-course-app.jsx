...
const TOOLS = [
  { tag: "// AGENT · CODE", name: "Claude Code", tone: "blue",
    desc: "An agentic coding tool that lives in the terminal. I describe what I want in plain language; it reads the whole codebase, writes and edits files, runs the build, and fixes its own errors. Almost every line of this site's React + Vite code was written this way, in a conversation rather than an IDE." },
    ...
    <Section id="top" padded={false} style={{ paddingTop: 150, paddingBottom: 40, position: "relative", overflow: "hidden" }}>
      ...
      <Container>
        ...
        <div className="t-body" style={{ color: "var(--muted)", maxWidth: 700, fontSize: 18, lineHeight: 1.6, marginTop: 16 }}>
          This whole portfolio, the code and the demos and the animations, was built in collaboration with AI. Here is the honest making-of: the tools, the workflow, and what a human still has to bring.
        </div>
      </Container>
    </Section>
  );
    ...
    <Section style={{ paddingTop: 8, paddingBottom: 64 }}>
      ...
      <Container style={{ maxWidth: 880, display: "flex", flexDirection: "column", gap: 40 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          <P>
            Every feature followed the same rhythm. First we would <b>plan</b> in conversation, covering what
            the section is for, how it should be structured and what tradeoffs matter, until the
            ...
            Then I would <b>review</b>: playtest it, react, correct. Then we would iterate. Big changes
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <P>
            It did not arrive fully formed. It grew in waves, each one a round of "build,
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12, marginTop: 4 }}>
            {[
              ...
              { n: "05", t: "Games & polish", d: "Add playable AI games, then a long polish pass over copy, accessibility, sitemap, broken-link cleanup and a deploy pipeline, toward a v1 worth publishing." },
            ].map(s => (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          <P>
            ...
            (every claim on this site has to be real, with no invented papers and no padded numbers),
            priorities (what's worth building at all), and voice. The AI proposes; I decide. That
            division is the whole point. It is not automation replacing the work, it is leverage
            multiplying it.
          </P>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          <P>
            Building with GenAI did not remove the engineering, it moved it up a level. The scarce
