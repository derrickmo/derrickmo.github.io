...
window.LECTURES = {
  "foundations": {
    ...
    notebooks: [
      ...
      { n: "01-03", t: "Pandas for Tabular Data", d: "California Housing", m: "15 min" },
      { n: "01-04", t: "Visualization with Matplotlib", d: "Synthetic", m: "15 min" },
      { n: "01-05", t: "Data Loading with PyTorch", d: "FashionMNIST", m: "20 min" },
      { n: "01-06", t: "Linear Algebra for Machine Learning", d: "Synthetic", m: "20 min" },
      { n: "01-07", t: "Probability & Statistics for ML", d: "Synthetic", m: "20 min" },
      { n: "01-08", t: "Information Theory for ML", d: "Synthetic", m: "15 min" },
      { n: "01-09", t: "Calculus & Optimization Foundations", d: "Synthetic", m: "20 min" },
      { n: "01-10", t: "Computational Thinking & Complexity", d: "Synthetic", m: "15 min" },
    ],
  },
  ...
  "supervised-learning": {
    ...
    notebooks: [
      ...
      { n: "02-03", t: "Decision Trees & Random Forests", d: "Iris + make_classification", m: "25 min" },
      { n: "02-04", t: "Gradient Boosting & AdaBoost", d: "California Housing", m: "25 min" },
      { n: "02-05", t: "Support Vector Machines", d: "make_moons + make_blobs", m: "25 min" },
      { n: "02-06", t: "Generalized Linear Models & Exponential Family", d: "Synthetic", m: "20 min" },
      { n: "02-07", t: "k-Nearest Neighbors", d: "Digits + make_blobs", m: "20 min" },
      { n: "02-08", t: "Naive Bayes for Text Classification", d: "20 Newsgroups", m: "20 min" },
      { n: "02-09", t: "Stacking & Voting Ensembles", d: "make_classification", m: "20 min" },
      { n: "02-10", t: "Model Comparison & Algorithm Selection", d: "California Housing + Iris", m: "25 min" },
    ],
  },
  ...
  "unsupervised-learning": {
    ...
    notebooks: [
      ...
      { n: "03-03", t: "Principal Component Analysis", d: "Digits + MNIST", m: "20 min" },
      { n: "03-04", t: "t-SNE, UMAP & Manifold Learning", d: "MNIST", m: "25 min" },
      { n: "03-05", t: "Independent Component Analysis", d: "Synthetic", m: "20 min" },
      { n: "03-06", t: "Gaussian Mixture Models & EM Algorithm", d: "make_blobs + Iris", m: "25 min" },
      { n: "03-07", t: "Anomaly Detection", d: "make_blobs + anomalies", m: "20 min" },
      { n: "03-08", t: "Kernel Methods & Feature Maps", d: "make_moons + Digits", m: "20 min" },
      { n: "03-09", t: "Matrix Factorization & Decomposition", d: "Synthetic", m: "25 min" },
      { n: "03-10", t: "Bayesian Inference & Probabilistic Thinking", d: "Synthetic", m: "25 min" },
    ],
  },
  ...
  "ml-theory": {
    ...
    notebooks: [
      ...
      { n: "04-03", t: "Feature Engineering & Pipelines", d: "California Housing", m: "20 min" },
      { n: "04-04", t: "Data Augmentation & Color Spaces", d: "CIFAR-10", m: "20 min" },
      { n: "04-05", t: "Handling Imbalanced Data", d: "make_classification", m: "20 min" },
      { n: "04-06", t: "Learning Theory — VC Dimension & PAC", d: "make_classification", m: "20 min" },
      { n: "04-07", t: "Bias-Variance Decomposition & Debugging", d: "make_classification + make_moons", m: "25 min" },
      { n: "04-08", t: "Convex Optimization Foundations", d: "make_classification + make_blobs", m: "20 min" },
      { n: "04-09", t: "Calibration & Uncertainty Quantification", d: "Digits + make_classification", m: "20 min" },
      { n: "04-10", t: "Gaussian Processes & Bayesian Optimization", d: "make_regression", m: "25 min" },
    ],
  },
  ...
  "neural-nets": {
    ...
    notebooks: [
      ...
      { n: "05-03", t: "Activation Functions", d: "make_moons + FashionMNIST", m: "15 min" },
      { n: "05-04", t: "Loss Functions", d: "MNIST", m: "15 min" },
      { n: "05-05", t: "Regularisation", d: "FashionMNIST", m: "15 min" },
      { n: "05-06", t: "Backpropagation", d: "Synthetic regression", m: "20 min" },
      { n: "05-07", t: "PyTorch Autograd", d: "Synthetic", m: "15 min" },
      { n: "05-08", t: "Weight Initialisation", d: "MNIST", m: "10 min" },
      { n: "05-09", t: "Optimisers", d: "FashionMNIST", m: "15 min" },
      { n: "05-10", t: "Complete MLP Pipeline", d: "FashionMNIST", m: "25 min" },
    ],
  },
  ...
  "cnn": {
    ...
    notebooks: [
      ...
      { n: "06-03", t: "LeNet-5 & AlexNet", d: "CIFAR-10", m: "20 min" },
      { n: "06-04", t: "VGGNet & Deep CNN Design", d: "CIFAR-10", m: "20 min" },
      { n: "06-05", t: "ResNet & Skip Connections", d: "CIFAR-10", m: "20 min" },
      { n: "06-06", t: "Transfer Learning & Fine-Tuning", d: "CIFAR-10", m: "20 min" },
      { n: "06-07", t: "Data Augmentation", d: "CIFAR-10", m: "15 min" },
      { n: "06-08", t: "Batch Normalization in CNNs", d: "CIFAR-10", m: "15 min" },
      { n: "06-09", t: "Depthwise Separable Convolutions", d: "CIFAR-10", m: "15 min" },
      { n: "06-10", t: "CNN Pipeline Capstone", d: "CIFAR-10", m: "25 min" },
    ],
  },
  ...
  "rnn-nlp": {
    ...
    notebooks: [
      ...
      { n: "07-03", t: "Recurrent Neural Networks", d: "WikiText-2", m: "20 min" },
      { n: "07-04", t: "LSTM & GRU", d: "WikiText-2", m: "25 min" },
      { n: "07-05", t: "Seq2Seq & Bahdanau Attention", d: "Synthetic", m: "20 min" },
      { n: "07-06", t: "Language Modeling (Practical)", d: "WikiText-2", m: "20 min" },
      { n: "07-07", t: "Perplexity & LM Evaluation", d: "WikiText-2", m: "15 min" },
      { n: "07-08", t: "Text Classification", d: "AG_NEWS", m: "20 min" },
      { n: "07-09", t: "Sequence Labeling & BiLSTM-CRF", d: "CoNLL-2000", m: "25 min" },
      { n: "07-10", t: "NLP Pipeline Capstone", d: "AG_NEWS", m: "25 min" },
    ],
  },
  ...
  "transformers": {
    ...
    notebooks: [
      ...
      { n: "08-03", t: "Positional Encoding", d: "Synthetic", m: "15 min" },
      { n: "08-04", t: "Transformer Encoder", d: "WikiText-2", m: "25 min" },
      { n: "08-05", t: "Transformer Decoder", d: "Synthetic", m: "20 min" },
      { n: "08-06", t: "GPT-style Language Model", d: "WikiText-2", m: "25 min" },
      { n: "08-07", t: "Transformer Text Classifier", d: "AG_NEWS", m: "20 min" },
      { n: "08-08", t: "BERT-style Masked LM", d: "WikiText-2", m: "25 min" },
      { n: "08-09", t: "Attention Visualisation & Analysis", d: "WikiText-2", m: "20 min" },
      { n: "08-10", t: "Transformer Capstone", d: "AG_NEWS + WikiText-2", m: "25 min" },
    ],
  },
  ...
  "advanced-cv": {
    ...
    notebooks: [
      ...
      { n: "09-03", t: "Semantic Segmentation — FCN & U-Net", d: "Synthetic masks", m: "25 min" },
      { n: "09-04", t: "Instance Segmentation Concepts", d: "Synthetic", m: "20 min" },
      { n: "09-05", t: "Vision Transformer (ViT)", d: "CIFAR-10", m: "25 min" },
      { n: "09-06", t: "Data Augmentation & Regularisation", d: "CIFAR-10", m: "20 min" },
      { n: "09-07", t: "Transfer Learning & Fine-tuning", d: "CIFAR-10", m: "20 min" },
      { n: "09-08", t: "Optical Flow", d: "Synthetic motion", m: "20 min" },
      { n: "09-09", t: "OCR with CRNN", d: "Synthetic digit strings", m: "25 min" },
      { n: "09-10", t: "CV Capstone", d: "CIFAR-10 + Synthetic", m: "30 min" },
    ],
  },
  ...
  "advanced-nlp": {
    ...
    notebooks: [
      ...
      { n: "10-03", t: "Token Classification (NER-style)", d: "Synthetic NER", m: "20 min" },
      { n: "10-04", t: "Sequence-to-Sequence Fine-tuning", d: "Synthetic summarisation", m: "25 min" },
      { n: "10-05", t: "Text Generation Evaluation", d: "Synthetic", m: "20 min" },
      { n: "10-06", t: "Retrieval-Augmented Generation (Lite)", d: "Synthetic QA", m: "20 min" },
      { n: "10-07", t: "Efficient Fine-tuning (LoRA-style)", d: "AG_NEWS + WikiText-2", m: "20 min" },
      { n: "10-08", t: "NLP Evaluation Pipeline", d: "AG_NEWS + WikiText-2", m: "20 min" },
      { n: "10-09", t: "In-Context Learning & Probing", d: "WikiText-2", m: "20 min" },
      { n: "10-10", t: "NLP Capstone", d: "AG_NEWS + WikiText-2", m: "30 min" },
    ],
  },
  ...
  "generative": {
    ...
    notebooks: [
      ...
      { n: "11-03", t: "Advanced GANs (WGAN-GP & cGAN)", d: "FashionMNIST", m: "25 min" },
      { n: "11-04", t: "Denoising Diffusion (DDPM)", d: "MNIST", m: "30 min" },
      { n: "11-05", t: "Diffusion Sampling & Guidance", d: "MNIST", m: "25 min" },
      { n: "11-06", t: "Normalizing Flows (RealNVP)", d: "MNIST (binarised)", m: "25 min" },
      { n: "11-07", t: "Evaluation of Generative Models", d: "MNIST", m: "20 min" },
      { n: "11-08", t: "Score Matching, EBMs & Flow Matching", d: "Synthetic 2-D", m: "20 min" },
      { n: "11-09", t: "Autoregressive Image Models", d: "MNIST", m: "25 min" },
      { n: "11-10", t: "Generative Models Capstone", d: "MNIST + FashionMNIST", m: "30 min" },
    ],
  },
  ...
  "multimodal": {
    ...
    notebooks: [
      ...
      { n: "12-03", t: "Visual Question Answering (VQA)", d: "Synthetic VQA", m: "25 min" },
      { n: "12-04", t: "Image Captioning (CNN + Transformer)", d: "MNIST + captions", m: "25 min" },
      { n: "12-05", t: "Audio-Visual Correspondence", d: "Synthetic audio-visual", m: "20 min" },
      { n: "12-06", t: "Vision-Language Pre-training Concepts", d: "MNIST + captions", m: "20 min" },
      { n: "12-07", t: "Cross-Modal Generation (DALL-E concept)", d: "MNIST + captions", m: "25 min" },
      { n: "12-08", t: "Multimodal Fusion Strategies", d: "MNIST + tabular", m: "20 min" },
      { n: "12-09", t: "Multimodal Evaluation Pipeline", d: "MNIST + captions", m: "20 min" },
      { n: "12-10", t: "Multimodal Capstone", d: "MNIST + FashionMNIST + Synthetic", m: "30 min" },
    ],
  },
  ...
  "fine-tuning": {
    ...
    notebooks: [
      ...
      { n: "13-03", t: "Reward Modelling", d: "Synthetic preference pairs", m: "25 min" },
      { n: "13-04", t: "PPO for RLHF", d: "Synthetic", m: "30 min" },
      { n: "13-05", t: "Direct Preference Optimisation (DPO)", d: "Synthetic preference pairs", m: "25 min" },
      { n: "13-06", t: "Constitutional AI & RLAIF Concepts", d: "Synthetic", m: "20 min" },
      { n: "13-07", t: "Prompt Tuning & Soft Prompts", d: "AG_NEWS", m: "20 min" },
      { n: "13-08", t: "Catastrophic Forgetting & Continual Learning", d: "MNIST (sequential)", m: "25 min" },
      { n: "13-09", t: "Fine-Tuning Evaluation & Safety", d: "Synthetic", m: "20 min" },
      { n: "13-10", t: "Alignment Capstone", d: "WikiText-2 + Synthetic", m: "30 min" },
    ],
  },
  ...
  "reinforcement-learning": {
    ...
    notebooks: [
      ...
      { n: "14-03", t: "Temporal Difference Learning", d: "Gridworld / CliffWalk / CartPole", m: "25 min" },
      { n: "14-04", t: "Deep Q-Networks (DQN)", d: "CartPole", m: "30 min" },
      { n: "14-05", t: "Advanced DQN Variants", d: "CartPole", m: "25 min" },
      { n: "14-06", t: "Policy Gradient — REINFORCE", d: "CartPole", m: "25 min" },
      { n: "14-07", t: "Actor-Critic & A2C", d: "CartPole", m: "25 min" },
      { n: "14-08", t: "Proximal Policy Optimisation (PPO)", d: "CartPole", m: "30 min" },
      { n: "14-09", t: "Model-Based RL Concepts", d: "Gridworld + CartPole", m: "25 min" },
      { n: "14-10", t: "RL Capstone", d: "CartPole + Gridworld", m: "30 min" },
    ],
  },
  ...
  "pytorch-internals": {
    ...
    notebooks: [
      ...
      { n: "15-03", t: "TorchScript — JIT Tracing & Scripting", d: "MNIST", m: "20 min" },
      { n: "15-04", t: "Custom nn.Module Patterns", d: "Synthetic", m: "20 min" },
      { n: "15-05", t: "Hooks, Callbacks & Gradient Analysis", d: "MNIST", m: "25 min" },
      { n: "15-06", t: "Memory Management", d: "MNIST / CIFAR-10", m: "20 min" },
      { n: "15-07", t: "Mixed-Precision Training (AMP)", d: "MNIST / CIFAR-10", m: "25 min" },
      { n: "15-08", t: "Gradient Checkpointing", d: "Synthetic deep MLP", m: "20 min" },
      { n: "15-09", t: "Debugging PyTorch Models", d: "Synthetic", m: "25 min" },
      { n: "15-10", t: "PyTorch Internals Capstone", d: "MNIST", m: "30 min" },
    ],
  },
  ...
  "training-systems": {
    ...
    notebooks: [
      ...
      { n: "16-03", t: "Regularisation Techniques", d: "CIFAR-10", m: "25 min" },
      { n: "16-04", t: "Batch Size Scaling & Linear Scaling Rule", d: "CIFAR-10", m: "20 min" },
      { n: "16-05", t: "Data Pipeline Optimisation", d: "CIFAR-10", m: "20 min" },
      { n: "16-06", t: "Distributed Training Concepts", d: "Synthetic", m: "20 min" },
      { n: "16-07", t: "Profiling with torch.profiler", d: "CIFAR-10", m: "25 min" },
      { n: "16-08", t: "Gradient Compression & Communication", d: "Synthetic", m: "20 min" },
      { n: "16-09", t: "Hyperparameter Optimisation", d: "CIFAR-10", m: "25 min" },
      { n: "16-10", t: "Training Optimisation Capstone", d: "CIFAR-10", m: "30 min" },
    ],
  },
  ...
  "llm-systems": {
    ...
    notebooks: [
      ...
      { n: "17-03", t: "KV-Cache & Positional Encodings", d: "Synthetic", m: "25 min" },
      { n: "17-04", t: "Quantisation — INT8, INT4, GPTQ", d: "WikiText-2", m: "25 min" },
      { n: "17-05", t: "Speculative Decoding", d: "Synthetic (GPT-2 style)", m: "25 min" },
      { n: "17-06", t: "Long-Context Techniques", d: "Synthetic", m: "20 min" },
      { n: "17-07", t: "Mixture of Experts (MoE)", d: "Synthetic", m: "25 min" },
      { n: "17-08", t: "LLM Evaluation", d: "WikiText-2", m: "25 min" },
      { n: "17-09", t: "LLM Inference Optimisation", d: "Synthetic", m: "20 min" },
      { n: "17-10", t: "LLM Systems Capstone", d: "Synthetic / WikiText-2", m: "30 min" },
    ],
  },
  ...
  "rag-agents": {
    ...
    notebooks: [
      ...
      { n: "18-03", t: "RAG Pipeline — Retrieve-then-Generate", d: "Synthetic docs + Q&A", m: "25 min" },
      { n: "18-04", t: "Query Rewriting & HyDE", d: "Synthetic Q&A", m: "20 min" },
      { n: "18-05", t: "Reranking & Fusion", d: "Synthetic Q&A", m: "20 min" },
      { n: "18-06", t: "RAG Evaluation (RAGAS-style)", d: "Synthetic", m: "25 min" },
      { n: "18-07", t: "Tool-Using Agents (ReAct)", d: "Synthetic tool-use", m: "25 min" },
      { n: "18-08", t: "Agent Memory Systems", d: "Synthetic conversations", m: "20 min" },
      { n: "18-09", t: "Multi-Agent Orchestration", d: "Synthetic multi-step", m: "20 min" },
      { n: "18-10", t: "Agentic RAG Capstone", d: "Synthetic docs + Q&A", m: "30 min" },
    ],
  },
  ...
  "ml-applications": {
    ...
    notebooks: [
      ...
      { n: "19-03", t: "Medical Imaging", d: "Synthetic medical images", m: "25 min" },
      { n: "19-04", t: "Recommender Systems", d: "Synthetic user-item data", m: "25 min" },
      { n: "19-05", t: "NLP for Code", d: "Synthetic code snippets", m: "25 min" },
      { n: "19-06", t: "Graph Neural Networks", d: "Synthetic graphs", m: "25 min" },
      { n: "19-07", t: "Semi-Supervised & Multi-Task Learning", d: "CIFAR-10 + Synthetic", m: "25 min" },
      { n: "19-08", t: "Fairness, Bias & Ethics in ML", d: "Synthetic tabular", m: "25 min" },
      { n: "19-09", t: "Structured Prediction", d: "Synthetic sequences", m: "25 min" },
      { n: "19-10", t: "Domain Applications Capstone", d: "Synthetic multi-domain", m: "30 min" },
    ],
  },
  ...
  "mlops": {
    ...
    notebooks: [
      ...
      { n: "20-03", t: "Model Serialisation & TorchScript", d: "FashionMNIST", m: "25 min" },
      { n: "20-04", t: "FastAPI Model Serving", d: "FashionMNIST", m: "30 min" },
      { n: "20-05", t: "Docker for ML Deployment", d: "FashionMNIST", m: "30 min" },
      { n: "20-06", t: "Kubernetes for ML Deployment", d: "FashionMNIST", m: "35 min" },
      { n: "20-07", t: "Model Monitoring & Data Drift", d: "FashionMNIST", m: "30 min" },
      { n: "20-08", t: "ML Testing & Project Standards", d: "FashionMNIST", m: "30 min" },
      { n: "20-09", t: "Online Experimentation & A/B Testing", d: "Synthetic", m: "25 min" },
...
window.LECTURE_CODE = {
  "foundations": { caption: "Why every later module lives in tensors, not loops.", code:
`import numpy as np
A = np.random.randn(1000, 1000)
b = np.random.randn(1000)
y = A @ b          # NumPy runs the loop in C...
# ...~100x faster than a Python "for i: y[i] = (A[i]*b).sum()"` },
  "supervised-learning": { caption: "Fit a model by following the gradient downhill.", code:
`for _ in range(epochs):
    y_hat = X @ w + b
    grad_w = X.T @ (y_hat - y) / n      # dLoss/dw
    w -= lr * grad_w                    # the move every model makes` },
  "unsupervised-learning": { caption: "K-means in two steps: assign, then move centroids.", code:
`for _ in range(iters):
    labels = np.argmin(((X[:, None] - C) ** 2).sum(-1), axis=1)  # assign
    C = np.array([X[labels == k].mean(0) for k in range(K)])     # update` },
  "ml-theory": { caption: "Cross-validation: never score on what you trained on.", code:
`scores = []
for tr, va in KFold(5).split(X):
    model.fit(X[tr], y[tr])
    scores.append(f1(y[va], model.predict(X[va])))
print(np.mean(scores), "±", np.std(scores))` },
  "neural-nets": { caption: "Backprop is just the chain rule, carefully bookkept.", code:
`z = X @ W + b
a = relu(z)
# backward
dz = dA * (z > 0)        # relu'(z)
dW = X.T @ dz
db = dz.sum(0)` },
  "cnn": { caption: "A convolution slides one small kernel over the image.", code:
`# output pixel = elementwise product of a patch and the kernel
out[i, j] = (patch(img, i, j) * kernel).sum()
# learn many kernels, stack layers -> a CNN that sees hierarchy` },
  "rnn-nlp": { caption: "An RNN carries a hidden state across the sequence.", code:
`h = torch.zeros(hidden)
for x_t in sequence:
    h = torch.tanh(Wx @ x_t + Wh @ h + b)   # memory through a loop` },
  "transformers": { caption: "The one equation behind every modern LLM.", code:
`# scaled dot-product attention
scores = Q @ K.transpose(-2, -1) / math.sqrt(d_k)
weights = scores.softmax(dim=-1)
out = weights @ V          # every token reads every other token` },
  "advanced-cv": { caption: "Detection starts with IoU — how much two boxes overlap.", code:
`inter = overlap_area(box_a, box_b)
iou = inter / (area(box_a) + area(box_b) - inter)
# keep the highest-scoring box, suppress overlaps (NMS)` },
  "advanced-nlp": { caption: "Fine-tuning: reuse the pretrained body, train a small head.", code:
`for p in model.encoder.parameters():
    p.requires_grad = False             # freeze what's already learned
logits = head(model.encoder(tokens))    # adapt, don't retrain` },
  "generative": { caption: "Diffusion: add noise, then learn to take it back out.", code:
`# forward: data -> noise (closed form)
x_t = sqrt(abar[t]) * x0 + sqrt(1 - abar[t]) * noise
# train a network to predict \`noise\`, then run the chain in reverse` },
  "multimodal": { caption: "CLIP: pull matching image/text together, push others apart.", code:
`logits = (img_emb @ txt_emb.T) * temperature
loss = (cross_entropy(logits, idx) + cross_entropy(logits.T, idx)) / 2
# one shared space for pixels and words` },
  "fine-tuning": { caption: "LoRA: freeze W, learn a tiny low-rank update.", code:
`# A: d->r, B: r->d, with r << d  (a few % of the params)
delta = (x @ A) @ B
y = x @ W_frozen + alpha * delta` },
  "reinforcement-learning": { caption: "Q-learning: bootstrap toward reward + best next value.", code:
`target = r + gamma * Q[s2].max()
Q[s, a] += alpha * (target - Q[s, a])   # learn from delayed reward` },
  "pytorch-internals": { caption: "Define your own gradient when you need to.", code:
`class Square(torch.autograd.Function):
    @staticmethod
    def forward(ctx, x): ctx.save_for_backward(x); return x * x
    @staticmethod
    def backward(ctx, g): (x,) = ctx.saved_tensors; return g * 2 * x` },
  "training-systems": { caption: "Mixed precision: fp16 math, fp32 stability.", code:
`with torch.autocast("cuda"):
    loss = model(x).loss
scaler.scale(loss).backward()           # train bigger + faster
scaler.step(opt); scaler.update()` },
  "llm-systems": { caption: "KV-cache: don't recompute the past at each new token.", code:
...
out = attention(q_new, k_cache, v_cache)   # why generation gets cheaper` },
  "rag-agents": { caption: "RAG: retrieve first, then condition generation on it.", code:
`docs = index.search(embed(query), k=5)        # find relevant context
answer = llm(prompt(query, context=docs))     # ground the answer in facts` },
  "ml-applications": { caption: "A GNN layer: aggregate neighbors, then transform.", code:
`# the same learning idea, retargeted to graphs
h_v = relu(W @ mean([h_u for u in neighbors(v)] + [h_v]))
# stack layers -> information flows across the graph` },
  "mlops": { caption: "A model in production is a function behind an endpoint.", code:
`@app.post("/predict")
