...
window.PLAY_GAMES = {
  games: [
    ...
    { slug: "tic-tac-toe", topic: "MINIMAX", title: "Tic-Tac-Toe", tone: "blue", status: "LIVE",
      blurb: "Take on a minimax player that searches the whole game tree. On Perfect, the best you can do is a draw, so try to find it.",
    ...
    { slug: "wordle", topic: "INFORMATION", title: "Wordle Solver Duel", tone: "blue", status: "LIVE",
      blurb: "Race an entropy-maximizing solver to the answer and see which guess actually carries the most information.",
  ...
  categories: [
    ...
    { name: "Board & Strategy", why: "The hard games, where search trees are too big to brute-force and there is hidden information and bluffing. Mini versions that keep the real algorithm: alpha-beta, MCTS, and regret minimization.", slugs: ["chess", "go", "poker"] },
  ],
