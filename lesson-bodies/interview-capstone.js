// GENERATED from content/lessons/interview-capstone/ by scripts/gen-lesson-pages.mjs — DO NOT EDIT.
    ...
    "interview": {
      ...
      "standard": [
        ...
        },
        {
          ...
          "deepDive": {
            "q": "What does that mean for how you prepare?",
      ...
      "standard": [
        {
          ...
          "deepDive": {
            "q": "What is the failure mode of the 'what would you do differently' answer?",
            "a": "The 'what would you do differently' answer has a failure mode worth avoiding: it should be a real technical judgement, not a humility performance. 'I'd have written more tests' is a non-answer; 'I'd have logged the assignment propensities from the start, because without them I couldn't answer any counterfactual question about the ranker later and retrofitting it onto the logs was impossible' is a real one, and it demonstrates that you learned something transferable. The same applies to the rejected option — 'I chose logistic regression over a GBDT because the output fed a cost-based threshold and I needed calibration, which cost about two points of PR-AUC' contains a decision, a constraint, a trade and a number in one sentence. Those sentences are hard to produce under pressure and easy to produce at a desk, which is precisely why pre-writing them is the highest-return hour in interview preparation. It is also useful independent of interviewing: a project you cannot summarize in four sentences is one you have not finished thinking about."
          }
        },
        {
