...
const DM_NAV_INDEX = [
  ...
  { label: "The Bias-Variance Trade-off - Machine Learning Theory", group: "Lesson", href: "/learn/ml-theory/bias-variance/", kw: "the bias variance trade off machine learning theory bias variance sub lesson concept generalization error splits into bias variance and irreducible noise" },
  ...
  { label: "Cross-Validation - Machine Learning Theory", group: "Lesson", href: "/learn/ml-theory/cross-validation/", kw: "cross validation machine learning theory cross validation sub lesson concept estimate true performance without ever touching the test set" },
