...
const DM_NAV_INDEX = [
  ...
  { label: "MDPs and the Bellman Equation - Reinforcement Learning", group: "Lesson", href: "/learn/reinforcement-learning/mdp-bellman/", kw: "mdps and the bellman equation reinforcement learning mdp bellman sub lesson concept frame sequential decisions and solve them with a recursive value identity" },
  { label: "Q-Learning - Reinforcement Learning", group: "Lesson", href: "/learn/reinforcement-learning/q-learning/", kw: "q learning reinforcement learning q learning sub lesson concept learn action values from experience without knowing the environment" },
  ...
  { label: "Policy Gradients - Reinforcement Learning", group: "Lesson", href: "/learn/reinforcement-learning/policy-gradient/", kw: "policy gradients reinforcement learning policy gradient sub lesson concept optimize the policy directly by following the gradient of expected reward" },
  { label: "Actor-Critic - Reinforcement Learning", group: "Lesson", href: "/learn/reinforcement-learning/actor-critic/", kw: "actor critic reinforcement learning actor critic sub lesson concept pair a policy actor with a learned value baseline critic" },
  ...
  { label: "Deep Q-Networks - Reinforcement Learning", group: "Lesson", href: "/learn/reinforcement-learning/dqn/", kw: "deep q networks reinforcement learning dqn sub lesson concept replace the q table with a network stabilized by replay and a target net" },
