...
const DM_NAV_INDEX = [
  ...
  { label: "Linear Regression - Supervised Learning", group: "Lesson", href: "/learn/supervised-learning/linear-regression/", kw: "linear regression supervised learning linear regression sub lesson concept fit a line or hyperplane by minimizing squared error" },
  { label: "Logistic Regression - Supervised Learning", group: "Lesson", href: "/learn/supervised-learning/logistic-regression/", kw: "logistic regression supervised learning logistic regression sub lesson concept a linear model squashed through a sigmoid for classification" },
  { label: "k-Nearest Neighbors - Supervised Learning", group: "Lesson", href: "/learn/supervised-learning/knn/", kw: "k nearest neighbors supervised learning knn sub lesson concept classify a point by the majority vote of its closest neighbors" },
  { label: "Naive Bayes - Supervised Learning", group: "Lesson", href: "/learn/supervised-learning/naive-bayes/", kw: "naive bayes supervised learning naive bayes sub lesson concept a probabilistic classifier that assumes features are independent" },
  ...
  { label: "Support Vector Machines - Supervised Learning", group: "Lesson", href: "/learn/supervised-learning/svm/", kw: "support vector machines supervised learning svm sub lesson concept separate the classes with the widest possible margin" },
